...
MLFLOW_TRACKING_URI = "https://dagshub.com/sandeshshrestha45/MLOPS-Capstone-Project.mlflow"
dagshub.init(repo_owner="sandeshshrestha45", repo_name="MLOPS-Capstone-Project", mlflow=True)
